...
@section('content')
    ...
    {{-- Datos personales --}}
    <form action="{{ route('admin.teachers.update', ['teacher' => $usuario]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mt-2" data-tab-id="3">
            ...
            <div class="input-columns-1">
                ...
                <div>
                    ...
                    <input class="acortado" type="number" autocomplete="off" value=0 id="datos_experiencia_presencial"
                           name="experiencia_presencial">
                </div>
                ...
                <div>
                    ...
                    <input class="acortado" type="number" autocomplete="off" value=0 id="datos_experiencia_linea"
                           name="experiencia_linea">
                </div>
                ...
                <div>
                    ...
                    <select style="margin-top:10px" class="select2-multiple" name="area_experiencia[]"
                            multiple="multiple">
                ...
                <div>
                    ...
                    <ul class="col2">
                        <li><input type="radio" id="l-otrolugar" name="disponibilidad_asesor" value="100%" checked>
                            <label for=""> %100</label>&#160;&#160;&#160;&#160;&#160;&#160;&#160;<input type="radio"
                                                                                                        id="l-otrolugar"
                                                                                                        name="disponibilidad_asesor"
                                                                                                        value="75%">
                            <label for=""> %75</label>&#160;&#160;&#160;&#160;&#160;&#160;&#160;<input type="radio"
                                                                                                       id="l-otrolugar"
                                                                                                       name="disponibilidad_asesor"
                                                                                                       value="50%">
                            <label for=""> %50</label>&#160;&#160;&#160;&#160;&#160;&#160;&#160;<input type="radio"
                                                                                                       id="l-otrolugar"
                                                                                                       name="disponibilidad_asesor"
                                                                                                       value="25%">
                ...
                <div style="margin-top:10px">
                    ...
                    <ul class="col2">
                        <li><label for="">Inicio:&#160;&#160;&#160;</label><input type="time" min="6:00:00"
                                                                                  max="24:00:00" name="horario_laboral">
                        </li>
                        <li><label for="">Cierre:&#160;&#160;&#160;</label><input type="time" min="6:00:00"
                                                                                  max="24:00:00" name="horario_laboral">
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="col8">
                        <li><input type="checkbox" id="l-otrolugar" name="dias_laboral" value="lunes"><label>
                                Lun.</label></li>
                        <li><input type="checkbox" id="dias_laboral" name="dias_laboral" value="martes"><label>
                                Mar.</label></li>
                        <li><input type="checkbox" id="dias_laboral" name="dias_laboral" value="miercoles"><label>
                                Mierc.</label></li>
                        <li><input type="checkbox" id="dias_laboral" name="dias_laboral" value="jueves"><label>
                                Juev.</label></li>
                        <li><input type="checkbox" id="dias_laboral" name="dias_laboral" value="viernes"><label>
                                Vier.</label></li>
                        <li><input type="checkbox" id="dias_laboral" name="dias_laboral" value="sabado"><label>
                                Sáb.</label></li>
                        <li><input type="checkbox" id="dias_laboral" name="dias_laboral" value="domingo"><label>
                                Dom.</label></li>
                ...
                <div>
                    <label for="text-input">Adjuntar archivo en pdf de su CV con ortografía actualizado al día de
                        hoy:</label>
                    <input type="file" accept="application/pdf" placeholder="Coloque su fotografia" id="curriculum_pdf"
                           name="curriculum_pdf">
                </div>
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            fetch("http://127.0.0.1:8000/profesores/getTeacherInfogetTeacherInfo/{{ $usuario->id_usuario }}")
