...
<form action="{{ route('admin.teachersimport.store') }}" method="post" enctype="multipart/form-data">
    @csrf
     <div class="mt-1" data-tab-id="1">
            <h3 class="tab--title"></h3>
             ...
             <div class="mt-2 input-columns-excel">

                 <div>
                    <label for="text-input" class="is-required"> Ingresa Archivo</label>
                    <input type="file" name="archivo" id="" class="form-control" accept=".xlsx, .xls">
                    ...
                    <div class="mt-0 alert-info-danger">
                       @if (isset($errors) && $errors->any() && !$errors->first('archivo') )
                ...
                <div class="conte">
                        <div class="leftexcel">
                            <button type="submit" name="archivo"  class="btn btn-primario text-white btn-lg d-block w-35" >
                            <h2>Guardar</h2>
                            </button>
                        </div>
                        <div class="rightexcel">
                            <a href="{{ route('admin.exportarejemplodocentes') }}" class="btn btn-primario text-white btn-lg d-block w-35">
                ...
                <p class="parrafo mt-1">3.- El campo género debe contener un solo caracter "1" o "0". "0" para Femenino o "1" para Masculino.</p>
                <p class="parrafo mt-1">4.- Formato de fecha de nacimiento "Año-Mes-Día"</p>
                <p class="parrafo mt-1">5.- En caso de crear su propio archivo de importación, usted debe tener el formato ".xlsx" y debe de tener las mismas características del archivo.
